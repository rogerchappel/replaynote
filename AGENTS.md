# Agent Operating Instructions for replaynote

This file defines how AI agents and human maintainers should work in `replaynote`.
...
- Default branch: ``
- Package manager: ``
- Primary verification command: `npm run validate`
...
6. Run `npm run validate` or a smaller targeted check when appropriate.
7. Commit atomically.
