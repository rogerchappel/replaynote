...
Replace this section with the supported versions for `replaynote`.
...
Do not imply paid support, guaranteed response times, guaranteed fixes, or service-level agreements unless `replaynote` explicitly provides them.

## Scope

In scope:

- Vulnerabilities in replaynote.
